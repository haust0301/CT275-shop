...
?>
<h3 style="color: #241C57;">Các sản phẩm mới</h3>
<div class="row mt-5">
	<?php
	...
	?>
		<div class="col-md-3 col-lg-2">
			<a href="index.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
				<img class="img img-responsive" style="width: 100%" src="admincp/modules/quanlysp/uploads/<?php echo $row['hinhanh'] ?>">
...
<ul class="list_trang">
	...
	?>
		<li <?php if ($i == $page) {
				echo 'style="background: #241C57; color: #000;"';
			} else {
				echo '';
