	...
	<form action="pages/main/xulythanhtoan.php" method="POST">
		<div class="row">
			...
			<div class="col-md-8 mt-4">
				...
				<table style="width:100%;text-align: center;border-collapse: collapse;" border="1" class="table table-bordered">
					...
					?>
						...
						<tr>
							<td colspan="8">
								<p style="float: left; color:red" class="font-weight-bold">Tổng tiền: <?php echo number_format($tongtien, 0, ',', '.') . 'vnđ' ?></p><br />
